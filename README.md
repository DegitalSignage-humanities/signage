...
- signage.mp4 : 再生する動画（差し替え対象）※90度回転した縦長動画
...
## 注意（ファイルサイズ）
- ブラウザからのアップロードは 1ファイル 25MB まで
- git push は 1ファイル 100MB まで（それ以上は LFS 等が必要）
- Pages は “推奨 1GB” の上限があるため、動画サイズ管理に注意
- 使用するディスプレイ（SHARP製　PN-HW431）の都合上、右に90度回転させた縦長動画をご用意ください。
